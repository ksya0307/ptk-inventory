  ...
  Widget build(BuildContext context) {
    return c_s.CustomStepper(
      ...
      steps: <c_s.Step>[
        c_s.Step(
          state:
              currentStep <= 0 ? c_s.StepState.indexed : c_s.StepState.complete,
        ...
        c_s.Step(
          state:
              currentStep <= 1 ? c_s.StepState.indexed : c_s.StepState.complete,
        ...
        c_s.Step(
          state:
              currentStep <= 2 ? c_s.StepState.indexed : c_s.StepState.complete,
