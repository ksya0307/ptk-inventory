  ...
  Widget build(BuildContext context) {
    return BlocListener<RepairBloc, RepairState>(
      listener: (context, state) {
        print(state.repairActionStatus);
        print(state.repairLoadingStatus);
      },
                ...
                child: Column(
                  ...
                  children: const [
                    ...
                    Padding(
                      ...
                      child: Text(
                        "1 Загрузка акта приема передачи...",
                        style: TextStyle(
                          color: greyDark,
                          fontFamily: 'Rubik',
                          fontSize: 14,
                      ...
                      child: PdfView(
                        builders: PdfViewBuilders<DefaultBuilderOptions>(
                                ...
                                child: Column(
                                  ...
                                  children: const [
                                    ...
                                    Padding(
                                      padding: EdgeInsets.only(top: 16),
                                      child: Text(
                                        "2 Загрузка акта приема-передачи...",
                                        style: TextStyle(
                                          color: greyDark,
                                          fontFamily: 'Rubik',
                                          fontSize: 14,
                                  ...
                                  child: Column(
                                    ...
                                    children: const [
                                      ...
                                      Padding(
                                        padding: EdgeInsets.only(top: 16),
                                        child: Text(
                                          "3 Загрузка акта приема-передачи...",
                                          style: TextStyle(
                                            color: greyDark,
                                            fontFamily: 'Rubik',
                                            fontSize: 14,
                          ...
                          errorBuilder: (_, error) => const Center(
                            child: Text(" 1 Что-то пошло не так"),
                          ),
                        ),
